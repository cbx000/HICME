...
\author{%
		FENG Sheng-Qin$^{1,2,3;1)}$\email{fengsq@ctgu.edu.cn}%
\quad AI Xin$^{1}$%
\quad PEI Lei$^{1}$%
\quad SUN Fei$^{1}$%
\quad ZHONG Yang$^{1}$%
...
\begin{center}
\includegraphics[width=8.5cm]{../fig01/fig01.eps}
...
\begin{center}
\includegraphics[width=8.5cm]{../fig02/fig02.eps}
\figcaption{\label{fig2}The comparisons among our result with Skokov's(a) and Tuchin's(b).}
\end{center}
...
\begin{center}
\includegraphics[width=8.5cm]{../fig03/fig03.eps}
...
\begin{center}
\includegraphics[width=8.5cm]{../fig04/fig04.eps}
\figcaption{\label{fig4}The results of the correlator $|a_{+-}|/a_{++}$ as a function of $b/R$ with different screening length $\lambda$.}
\end{center}
...
\begin{center}
\includegraphics[width=8.5cm]{../fig05/fig05.eps}
...
We compare our calculation results with the experimental resutls of background-subtracted correlator $H$. The results show that our method explains the experimental data better at RHIC than that of LHC energy. The failure of our method at high energy may be due to the assumption that the magnetic field is homogeneously distributed in space which is not satisfied at high energy. The specific explanation remains to be further studied. The centrality dependence of correlator $|a_{+-}|/a_{++}$ for different screening length is presented, and the results are similar to that of Ref.~\cite{Kharzeev:2007jp}. At last, we gave an estimation of correlator $a_{++} - a_{+-}$ for Cu-Cu collisions at RHIC energy, and find it is much smaller than that of Au-Au collisions with same energy and centrality.

\section*{Acknowledgments}
This work was supported by National Natural Science Foundation of China (Grant Nos. 11475068, 11247021, 11447023), the CCNU-QLPL Innovation Fund (Grant No. QLPL2014P01), the Excellent Youth Foundation of Hubei Scientific Committee (Grant No. 2006ABB036).
...
\bibitem{Kharzeev:2007jp} D.~E. Kharzeev, L.~D. McLerran, H.~J. Warringa. Nucl. Phys. A, 2008, \textbf{803}: 227-253

\bibitem{Warringa:2008kv} H.~J. Warringa. J. Phys. G, 2008, \textbf{35}: 104012
\bibitem{Fukushima:2008xe} K.~Fukushima, D.~E. Kharzeev, H.~J. Warringa. Phys. Rev. D, 2008, \textbf{78}: 074033
\bibitem{Li:2014bha} Q.~Li, D.~E. Kharzeev, C.~Zhang, Y.~Huang, I.~Pletikosic, A.~V. Fedorov, R.~D. Zhong, J.~A. Schneeloch, G.~D. Gu, T.~Valla. Nature Phys., 2016, \textbf{12}: 550--554
\bibitem{Skokov:2009qp} V.~Skokov, A.~Yu. Illarionov, V.~Toneev. Int. J. Mod. Phys. A, 2009, \textbf{24}: 5925--5932
\bibitem{Voronyuk:2011jd} V.~Voronyuk, V.~D. Toneev, W.~Cassing, E.~L. Bratkovskaya, V.~P. Konchakovski, S.~A. Voloshin. Phys. Rev. C, 2011, \textbf{83}: 054911
\bibitem{Bzdak:2011yy} A.~Bzdak, V.~Skokov. Phys. Lett. B, 2012, \textbf{710}: 171--174
\bibitem{Deng:2012pc} W.-T. Deng, X.-G. Huang, Phys. Rev. C, 2012, \textbf{85}: 044907
\bibitem{Tuchin:2013apa} K.~Tuchin. Phys. Rev. C, 2013, \textbf{88}: 024911
\bibitem{Mo:2013qya} Y.-J. Mo, S.-Q. Feng, Y.-F. Shi. Phys. Rev. C, 2013, \textbf{88}: 024901
\bibitem{Abelev2009ac} B.~I. Abelev, et~al. Phys. Rev. Lett., 2009, \textbf{103}: 251601
\bibitem{Abelev:2009ad} B.~I. Abelev, et~al. Phys. Rev. C, 2010, \textbf{81}: 054908
\bibitem{Voloshin:2008jx} S.~A. Voloshin, et~al. Indian J. Phys., 2011, \textbf{85}: 1103--1107
\bibitem{PhysRevC.88.064911} L.~Adamczyk, et~al. Phys. Rev. C, 2013, \textbf{88}: 064911
\bibitem{Wang:2012qs} G.~Wang. Nucl. Phys. A, 2013, \textbf{904-905}: 248c--255c
\bibitem{Adamczyk:2014mzf} L.~Adamczyk, et~al. Phys. Rev. Lett., 2014, \textbf{113}: 052302
\bibitem{Adamczyk:2013kcb} L.~Adamczyk, et~al. Phys. Rev. C, 2014, \textbf{89}: 044908
\bibitem{Ajitanand:2010} N.~N. Ajitanand, S.~Esumi, R.~A. Lacey. in: Proc. of the RBRC Workshops, 2010, \textbf{96}
\bibitem{Christakoglou:2011uqg} P.~Christakoglou. J. Phys. G, 2011, \textbf{38}: 124165
\bibitem{PhysRevLett.110.012301} B.~Abelev, et~al. Phys. Rev. Lett., 2013, \textbf{110}: 012301
\bibitem{Wang:2016mkm} G.~Wang, L.~Wen. Adv. High Energy Phys., 2017, \textbf{2017}: 9240170
\bibitem{Voloshin:2004vk} S.~A. Voloshin. Phys. Rev. C, 2004, \textbf{70}: 057901
\bibitem{Schlichting:2010qia} S.~Schlichting, S.~Pratt. Phys. Rev. C, 2011, \textbf{83}: 014913
\bibitem{Pratt:2010zn} S.~Pratt, S.~Schlichting, S.~Gavin. Phys. Rev. C, 2011, \textbf{84}: 024909
\bibitem{Bzdak:2012ia} A.~Bzdak, V.~Koch, J.~Liao. Lect. Notes Phys., 2013, \textbf{871}:503--536
\bibitem{Tuchin:2010vs} K.~Tuchin. Phys. Rev. C, 2010, \textbf{82}: 034904
\bibitem{Tuchin:2010vs2} K.~Tuchin. Phys. Rev. C, 2011, \textbf{83}: 039903
\bibitem{McLerran:2013hla} L.~McLerran, V.~Skokov. Nucl. Phys. A, 2014, \textbf{929}: 184--190
\bibitem{Tuchin:2013ie} K.~Tuchin. Adv. High Energy Phys., 2013, \textbf{2013}: 490495
\bibitem{Zakharov:2014dia} B.~G. Zakharov. Phys. Lett. B, 2014, \textbf{737}: 262--266
\bibitem{Tuchin:2014iua} K.~Tuchin. Phys. Rev. C, 2015, \textbf{91}: 064902
\bibitem{Tuchin:2015oka} K.~Tuchin. Phys. Rev. C, 2016, \textbf{93}: 014905
\bibitem{Diakonov:2002fq} D.~Diakonov. Prog. Part. Nucl. Phys., 2003, \textbf{51}: 173--222
\bibitem{Schafer:1995pz} T.~Sch?fer, E.~V. Shuryak. Phys. Rev. D, 1996, \textbf{53}: 6522--6542
\bibitem{Arnold:1987zg} P.~B. Arnold, L.~D. McLerran. Phys. Rev. D, 1988, \textbf{37}: 1020
\bibitem{Fukugita:1990gb} M.~Fukugita, T.~Yanagida. Phys. Rev. D, 1990, \textbf{42}: 1285--1286
\bibitem{Arnold:2003zc} P.~B. Arnold, G.~D. Moore, L.~G. Yaffe. JHEP, 2003, \textbf{05}: 051
\bibitem{Gupta:2003zh} S.~Gupta. Phys. Lett. B, 2004, \textbf{597}: 57--62
\bibitem{Ding:2010ga} H.~T. Ding, A.~Francis, O.~Kaczmarek, F.~Karsch, E.~Laermann, W.~Soeldner. Phys. Rev. D, 2011, \textbf{83}: 034504
\bibitem{Francis:2011bt} A.~Francis, O.~Kaczmarek. Prog. Part. Nucl. Phys., 2012, \textbf{67}: 212--217
\bibitem{Ollitrault:2008zz} J.-Y. Ollitrault. Eur. J. Phys., 2008, \textbf{29}: 275--302
\bibitem{Kharzeev:2000ph} D.~Kharzeev, M.~Nardi. Phys. Lett. B, 2001, \textbf{507}: 121--128
\bibitem{Kowalski:2007rw} H.~Kowalski, T.~Lappi, R.~Venugopalan. Phys. Rev. Lett., 2008, \textbf{100}: 022303
\bibitem{Ray:2007av} R.~L. Ray, M.~Daugherity. J. Phys. G, 2008, \textbf{35}: 125106
\bibitem{Abelev:2013qoq} B.~Abelev, et~al. Phys. Rev. C, 2013, \textbf{88}: 044909
\bibitem{Aamodt:2011cdo} K.~Aamodt, et~al. Phys. Rev. Lett., 2011, \textbf{106}: 032301
