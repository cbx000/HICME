...
Pb276001 = csvread('../data/eta/Pb2760GeV0.1.dat',1,0);
Pb276002 = csvread('../data/eta/Pb2760GeV0.2.dat',1,0);
Pb276003 = csvread('../data/eta/Pb2760GeV0.3.dat',1,0);
...
Pb2760HAlpha = 4.36236922231 ; % lambda = 0.1
% linewidth = 2;
% fontsize = 18;
% markersize = 10;
figure
...
plot(1:8,(Au20001(1:8,1) - Au20001(1:8,2))*Au200HAlpha,'-k','LineWidth',linewidth)
set(gca,'linewidth',2);
...
plot(1:8,Pb276001Diff*Pb2760HAlpha,'-k','LineWidth',linewidth)
set(gca,'linewidth',2);
...
plot(1:7,(Au20001(1:7,1) - Au20001(1:7,2))*Au200HAlpha,'-r','LineWidth',linewidth)
plot(1:7,Pb2760Hdiff(1:end-1),'bo','MarkerSize',markersize)
plot(1:7,Pb276001Diff(1:end-1)*Pb2760HAlpha,'--b','LineWidth',linewidth)
set(gca,'linewidth',2);
